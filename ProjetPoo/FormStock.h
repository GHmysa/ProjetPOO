...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panelDelete->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnVSupprimer->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnInsert->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnAffiche->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->panelSelect->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnVSelect->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->txtBirth->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->panelInsert->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnVInsert->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->txtInsertHiring->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->txtInsertNom->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->panelUpdate->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnVModifier->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->btnBack->Location = System::Drawing::Point(13, 906);
